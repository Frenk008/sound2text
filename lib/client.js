...
var DEFAULT_QUICK_PROMPT = "\u8BF7\u89E3\u8BFB\u8FD9\u6BB5\u5185\u5BB9";
...
function Sound2TextPanel({ ctx }) {
  ...
  const [quickPrompt, setQuickPrompt] = (0, import_react.useState)(DEFAULT_QUICK_PROMPT);
  const [asrBusy, setAsrBusy] = (0, import_react.useState)(false);
  const [partial, setPartial] = (0, import_react.useState)(null);
  ...
  const ask = (0, import_react.useCallback)(async (preset) => {
...
\u6211\u7684\u95EE\u9898\uFF1A${q}`;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "s2t-panel", style: { width }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "s2t-head", children: [
      ...
      (asrBusy || partial) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "s2t-busy", children: "\u8BC6\u522B\u4E2D\u2026" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          entries.length === 0 && !asrBusy && !partial && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "s2t-empty", children: [
            "\u70B9\u51FB\u300C\u5F00\u59CB\u76D1\u542C\u300D\uFF0C\u7136\u540E\u64AD\u653E\u4EFB\u610F\u89C6\u9891\u3001\u76F4\u64AD\u6216\u4F1A\u8BAE\u97F3\u9891\uFF0C\u5B57\u5E55\u4F1A\u5B9E\u65F6\u51FA\u73B0\u5728\u8FD9\u91CC\u3002",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
            "\u5212\u9009\u4EFB\u610F\u6587\u5B57\uFF0C\u53EF\u76F4\u63A5\u5C31\u8FD9\u6BB5\u5185\u5BB9\u5411 DeepSeek \u63D0\u95EE\u3002"
          ] }),
          entries.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `s2t-item${e.dim ? " dim" : ""}`, children: [
          ...
          partial && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "s2t-item partial", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "s2t-time", children: fmtTime(partial.at) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "s2t-text", children: partial.text })
          ] }),
